# Stock History- Frontend Code

This directory contains the frontend code for the Stock History plugin.
...
This will compile the frontend into the `../stock_history/static` directory (ready for distribution).
